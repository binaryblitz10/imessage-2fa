...
## [Update] - 2025-09-13
## Fixed
- Apple Mail 2FA codes not showing in the extension.
  - Improved mailbox selection logic (handles multiple accounts and fallbacks to unified inbox).
  - Fixed date parsing to prevent messages being skipped due to invalid formats.
  - Improved message content retrieval with quoted-printable decoding.
  - Added better handling of plain text and HTML content for 2FA code extraction.
